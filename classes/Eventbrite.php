...
class Eventbrite {
    ...
    /**
     * This provides the web page used to give the user feedback on setup.
     *  
     * @param type $params
     * @return string
     */
    ...
    /**
     * Returns what we do after OAUTH - needed for Eventbrite API
     * @param type $key
     * @return type
     */
    ...
    /**
     * Gets the list of events and appends them inside an HTML DIV
     * 
     * @param type $evnts
     * @param type $callback
     * @param type $options
    ...
    /**
     * Get the Eventbrite access token from the session if possible
     * 
     * @return type
     */
    ...
    /**
     * Build a div with the event for display
     * 
     * @param type $evnt
     * @return type
     */
     ...
     * 
     * @param type $options
     * @param type $get_token
     * @param type $save_token
     * @param type $delete_token
     * @param type $render_login_box
     * @return string
     */
